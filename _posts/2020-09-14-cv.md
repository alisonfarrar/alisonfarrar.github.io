...
# Education
Doctoral student in the [Interdisciplinary Bioscience Doctoral Training Program](http://163.1.28.33/), the [Department of Condensed Matter Physics](https://www.physics.ox.ac.uk/research/subdepartment/condensed-matter-physics), and the [Kavli Institute for NanoScience Discovery](https://kavlifoundation.org/institutes/kavli-institute-for-nanoscience-discovery)\
...
Developing novel methods for the rapid detection of antibiotic susceptibility in clinical samples and using single-molecule imaging to investigate cross-talk between cellular translation and replication machinery in bacteria. Optimized fluorescence in situ hybridization protocols for detecting antimicrobial resistance gene products in clinical samples.
